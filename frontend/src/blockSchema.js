  ...
  image: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Layout",
        fields: [
          { key: "image_align", label: "Align", type: "align", noJustify: true, hint: "Position the image horizontally within the block" },
          ...
          },
          {
            ...
            showWhen: (props) => !!props?.image_url,
          },
        ],
      },
      {
  ...
  button: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Layout",
        fields: [
          { key: "align", label: "Alignment", type: "align", noJustify: true },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "align", label: "H Align", type: "align", noJustify: true },
          { key: "vertical_align", label: "V Align", type: "valign" },
        ],
      },
      {
