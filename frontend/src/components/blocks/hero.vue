  ...
  <BlockWrapper :block="block" :index="index">
    ...
    >
      <div
        ...
        :style="{ color: block.props.heading_color, fontSize: block.props.heading_size || '30px', fontFamily: fontStack(block.props.font_family, 'Georgia, \'Times New Roman\', serif'), letterSpacing: block.props.letter_spacing || 'normal' }"
      ...
      <div
        ...
        :style="{ color: block.props.subheading_color, fontFamily: fontStack(block.props.font_family, 'Arial, Helvetica, sans-serif'), letterSpacing: block.props.letter_spacing || 'normal' }"
        contenteditable="true"
